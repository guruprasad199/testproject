    ...
    return (
      <Grid container>
        <Grid container className={classes.footerContainer}>
          <Grid item xs={12} md={4}>
            <div >
              ...
              <div className={classes.footerDelhiImgContainer}>
                <img src={DelhiToursim} alt="Logo" className={classes.footerDelhiLogo} />
                <img src={DelhiLogo} alt="Logo" className={classes.footerDelhiLogo2} />
              </div>
            </div>
          </Grid>
          <Grid item xs={12} md={4}>
            <div className={classes.footerSecondContent}>
              ...
              <Hidden smDown>
                <div className={classes.navgiationList}>
                  ...
                  <Link to="TermsAndConditions" className={classes.footerQuickLinkText}>
                    Terms & Conditions
                  </Link>
                  <Link to="RefundPolicy" className={classes.footerQuickLinkText}>
                    Refund Policy
                  </Link>
                </div>
              </Hidden>
              <Hidden mdUp>
                <Grid container>
                  <Grid item xs={6} className={classes.mobileNavgiationList}><Link to="/faq" className={classes.footerQuickLinkText}>
                    Frequently Asked Questions
                  </Link>
                    <Link to="" className={classes.footerQuickLinkText}>
                      Contact Us
                  ...
                  <Grid item xs={6} className={classes.mobileNavgiationList}><Link to="" className={classes.footerQuickLinkText}>
                    About Us
                  </Link>
                    <Link to="TermsAndConditions" className={classes.footerQuickLinkText}>
                      Terms & Conditions
          ...
          <Grid item xs={12} md={4}>
            <div className={classes.footerContent}>
              ...
              <Hidden mdUp>
                <div style={{ height: 1, background: "#fff", width: "100%", marginBottom:24 }}></div>
              </Hidden>
              <Hidden mdUp>
                <p className={classes.contactHeading}>Contact Info</p>
              </Hidden>
              <div className={classes.footerSubscribeContent}>
                <img src={contact} alt="contact" className={classes.footerIconStyle} />
                <p className={classes.footerContactText}>+91 991 017 5472</p>
              </div>
              <div className={classes.footerSubscribeContent2}>
                <img src={location} alt="contact" className={classes.footerIconStyle} />
                <p className={classes.footerContactText} style={{ width: "80%" }}>
                  Gate no.-2, Sanjay Lake, Pocket D, Mayur Vihar, New Delhi, Delhi
                  110091, India
                </p>
              </div>
            </div>
        ...
        <Grid container className={classes.socialContainer}>
          ...
          <Grid item xs={12} md={4} className={classes.copyrightText}>&#169; 2023 e-o-d. All Rights Reserved.</Grid>
          <Grid item xs={12} md={4} className={classes.socialLinksContainer}>
            <a href="https://www.facebook.com/eodadventure/" target="_blank" rel="noopener noreferrer">
              <img src={facebook} alt="" className={classes.socialLogoStyleFb} />
            </a>
            <a href="https://www.instagram.com/eod_adventurepark/" target="_blank" rel="noopener noreferrer">
              <img src={Insta} alt="" className={classes.socialLogoStyleInsta} />
            </a>
            <a>
              <img src={LinkedIn} alt="" className={classes.socialLogoStyleLn} />
            </a>
            <a href="https://twitter.com/eodadventurepa1?lang=en" target="_blank" rel="noopener noreferrer">
