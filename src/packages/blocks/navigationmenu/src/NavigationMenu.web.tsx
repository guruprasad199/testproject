...
export default class NavigationMenu extends NavigationMenuController {
  ...
  renderSignUpFailed = () => {
    return (
      <Modal
        open={this.state.isSuccessMessage}
        onClose={this.modalClose}
        aria-labelledby="modal-modal-title"
        aria-describedby="modal-modal-description"
        data-testid="new_spend_modal"
      >
        <Box className={this.props.classes?.modalWrapper}>
          <img src={thanksImg} alt="successLogo" style={{ width: "150px" }} />
          <Typography
            id="modal-modal-title"
            variant="h6"
            component="h2"
            className={this.props.classes?.textMessageWrap}>
        ...
        <Grid container className={classes?.footerContainer}>
          ...
          <Grid item xs={12} md={4}>
            <div className={classes?.footerContent}>
              ...
              <button
                data-test-id="handleButtonSubmit"
                onClick={this.handleEmailSubmit}
                type="button"
                className={classes?.subscribeButtonStyle}
              >
                Subscribe
              </button>
              <Hidden mdUp>
...
const Footer = withStyles(muistyles)(NavigationMenu);
export { Footer };
// Customizable Area End
