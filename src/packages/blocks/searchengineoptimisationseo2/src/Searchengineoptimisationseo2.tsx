...
import Searchengineoptimisationseo2Controller, {
  Props,
  configJSON,
} from "./Searchengineoptimisationseo2Controller";

export default class Searchengineoptimisationseo2 extends Searchengineoptimisationseo2Controller {
