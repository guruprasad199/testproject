...
import CfpaymentintegrationwithrazorpayController, {
  Props,
  configJSON,
} from "./CfpaymentintegrationwithrazorpayController";

export default class Cfpaymentintegrationwithrazorpay extends CfpaymentintegrationwithrazorpayController {
