...
resolveApp('../blocks/searchengineoptimisationseo2/src/'),
...
resolveApp('../blocks/customform4/src/'),
resolveApp('../blocks/barcodesscanner2/src/'),
...
resolveApp('../blocks/automaticformcreation/src/'),
...
resolveApp('../blocks/barcodesscanner/src/'),
resolveApp('../blocks/audittrail2/src/'),
resolveApp('../blocks/ticketsystem2/src/'),
resolveApp('../blocks/uploadmedia3/src/'),
resolveApp('../blocks/cfpaymentintegrationwithrazorpay/src/'),
resolveApp('../blocks/googlereview/src/'),
  ...
  resolveApp('../blocks/settings2/mock'),
  resolveApp('../blocks/landingpage/mock')
]
